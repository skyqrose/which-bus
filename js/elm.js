...
var $author$project$Model$OnUrlRequest = function (a) {
...
var $author$project$Model$ChoosingRoute = {$: 'ChoosingRoute'};
var $author$project$Model$NotMakingNewSelection = {$: 'NotMakingNewSelection'};
...
var $author$project$Main$apiHost = $author$project$Mbta$Api$Default(
	{
		apiKey: $elm$core$Maybe$Just('3a6d67c08111426d8617a30340a9fad3')
	});
...
var $author$project$JsonApi$decodeResource = F2(
	function (_v0, untypedResource) {
		var documentDecoder = _v0.a;
...
var $author$project$JsonApi$decodeIncluded = F2(
	function (_v0, untypedResources) {
		var emptyIncluded = _v0.emptyIncluded;
		var accumulator = _v0.accumulator;
		return A3(
			$elm$core$List$foldl,
			F2(
	...
	function (attributeName, attributeDecoder) {
		return $author$project$JsonApi$custom(
			$author$project$JsonApi$ResourceDecoder(
				function (untypedResource) {
					var _v0 = A2($elm$core$Dict$get, attributeName, untypedResource.attributes);
					if (_v0.$ === 'Just') {
						var attributeJson = _v0.a;
						return A2(
							$elm$core$Result$mapError,
...
var $author$project$JsonApi$byType = function (resourceDecoders) {
	return $author$project$JsonApi$ResourceDecoder(
		function (untypedResource) {
			var _v0 = A2($elm$core$Dict$get, untypedResource.id.resourceType, resourceDecoders);
			if (_v0.$ === 'Just') {
				var resourceDecoder = _v0.a;
					...
					F2(
						function (resourceDecoder, previousResult) {
							if (previousResult.$ === 'Err') {
								...
								var _v1 = A2($author$project$JsonApi$decodeResource, resourceDecoder, untypedResource);
								if (_v1.$ === 'Err') {
									var newError = _v1.a;
									return $elm$core$Result$Err(
...
var $author$project$Mbta$Decode$maybeLatLng = A2(
	...
	function (_v0) {
		var maybeLat = _v0.a;
		var maybeLng = _v0.b;
		var _v1 = _Utils_Tuple2(maybeLat, maybeLng);
		if (_v1.a.$ === 'Just') {
			if (_v1.b.$ === 'Just') {
				var lat = _v1.a.a;
				var lng = _v1.b.a;
...
var $author$project$JsonApi$relationshipMaybe = F2(
	function (relationshipName, relatedIdDecoder) {
		return $author$project$JsonApi$custom(
			$author$project$JsonApi$ResourceDecoder(
				function (untypedResource) {
					var _v0 = A2($elm$core$Dict$get, relationshipName, untypedResource.relationships);
					if (_v0.$ === 'Just') {
						if (_v0.a.$ === 'RelationshipOne') {
							var maybeRelatedId = _v0.a.a;
...
var $author$project$DecodeHelpers$colorDecoder = A2(
	$elm$json$Json$Decode$andThen,
	function (chars) {
		var _v0 = $elm$core$String$toList(chars);
		...
		return $author$project$JsonApi$custom(
			$author$project$JsonApi$ResourceDecoder(
				function (untypedResource) {
					var _v0 = A2($elm$core$Dict$get, relationshipName, untypedResource.relationships);
					if (_v0.$ === 'Just') {
						if (_v0.a.$ === 'RelationshipMany') {
							var relatedIds = _v0.a.a;
							return A2(
								$elm$core$Result$mapError,
								$author$project$JsonApi$RelationshipIdError(relationshipName),
								$author$project$ResultHelpers$combine(
	...
	function (relationshipName, relatedIdDecoder) {
		return $author$project$JsonApi$custom(
			$author$project$JsonApi$ResourceDecoder(
				function (untypedResource) {
					var _v0 = A2($elm$core$Dict$get, relationshipName, untypedResource.relationships);
					if (((_v0.$ === 'Just') && (_v0.a.$ === 'RelationshipOne')) && (_v0.a.a.$ === 'Just')) {
						var relatedId = _v0.a.a.a;
						return A2(
							$elm$core$Result$mapError,
							$author$project$JsonApi$RelationshipIdError(relationshipName),
							A2($author$project$JsonApi$decodeId, relatedIdDecoder, relatedId));
...
var $author$project$Mbta$Decode$routeDirections = A2(
	...
	function (_v0) {
		...
		var _v1 = _Utils_Tuple2(names, destinations);
		_v1$2:
		while (true) {
			if (_v1.a.$ === 'Just') {
				if ((((((_v1.a.a.b && _v1.a.a.b.b) && (!_v1.a.a.b.b.b)) && (_v1.b.$ === 'Just')) && _v1.b.a.b) && _v1.b.a.b.b) && (!_v1.b.a.b.b.b)) {
					var _v2 = _v1.a.a;
					var d0_name = _v2.a;
					var _v3 = _v2.b;
					var d1_name = _v3.a;
					var _v4 = _v1.b.a;
					var d0_destination = _v4.a;
					var _v5 = _v4.b;
					var d1_destination = _v5.a;
					return $author$project$JsonApi$succeed(
						$elm$core$Maybe$Just(
							{
...
var $author$project$Main$getRoutes = A4($author$project$Mbta$Api$getRoutes, $author$project$Model$ReceiveRoutes, $author$project$Main$apiHost, _List_Nil, _List_Nil);
var $author$project$Model$ReceiveRoutesForStopId = F2(
	function (a, b) {
...
var $author$project$Mbta$Api$stopIdToString = function (_v0) {
	var stopId = _v0.a;
	return stopId;
};
var $author$project$Mbta$Api$filterRoutesByStopIds = function (stopIds) {
...
var $author$project$Selection$Selection = F3(
	function (routeIds, stopId, directionId) {
		return {directionId: directionId, routeIds: routeIds, stopId: stopId};
	});
...
var $author$project$UrlParsing$parseRouteIds = function (routeIdsString) {
	return A2(
		...
		A2(
			$elm$core$List$filter,
			$elm$core$Basics$neq(''),
			A2($elm$core$String$split, '.', routeIdsString)));
};
var $author$project$UrlParsing$parseStopId = function (stopIdString) {
	if (stopIdString === '') {
		return $elm$core$Maybe$Nothing;
	} else {
		return $elm$core$Maybe$Just(
...
var $author$project$UrlParsing$parseSelectionFields = F3(
	function (routeIdsString, stopIdString, directionIdString) {
		var stopIdResult = $author$project$UrlParsing$parseStopId(stopIdString);
		...
		return A3(
			$elm$core$Maybe$map2,
			$author$project$Selection$Selection(routeIds),
			stopIdResult,
			directionIdResult);
	});
...
var $author$project$UrlParsing$selectionsQueryParser = A2(
	...
	'stop',
	$elm$core$List$filterMap($author$project$UrlParsing$parseSelection));
var $author$project$UrlParsing$selectionsUrlParser = $elm$url$Url$Parser$query($author$project$UrlParsing$selectionsQueryParser);
var $author$project$UrlParsing$parseSelectionsFromUrl = function (url) {
	return A2(
		$elm$core$Maybe$withDefault,
		_List_Nil,
		A2(
			$elm$url$Url$Parser$parse,
			$author$project$UrlParsing$selectionsUrlParser,
			_Utils_update(
				url,
				{path: '/'})));
};
var $author$project$Main$startStream = _Platform_outgoingPort('startStream', $elm$json$Json$Encode$string);
var $author$project$Mbta$Api$routeIdToString = function (_v0) {
	var routeId = _v0.a;
	return routeId;
};
...
var $author$project$Mbta$Api$include = function (_v0) {
	var s = _v0.a;
...
var $author$project$Mbta$Api$predictionRoute = $author$project$Mbta$Api$Relationship('route');
var $author$project$Mbta$Api$predictionSchedule = $author$project$Mbta$Api$Relationship('schedule');
...
var $author$project$Mbta$Api$streamPredictions = F3(
	function (host, includes, filters) {
		return _Utils_Tuple2(
			$author$project$Mbta$Api$StreamState(
				{
					dataField: A2(
						$elm$core$Basics$composeR,
						function ($) {
					...
					mixedResult: $author$project$Mbta$Api$StreamResultInternal_Loading
				}),
			A4(
				$author$project$Mbta$Api$makeUrl,
				host,
...
var $author$project$Main$streamPredictions = function (selections) {
	return A3(
		...
		_List_fromArray(
			[
				$author$project$Mbta$Api$include($author$project$Mbta$Api$predictionStop),
				$author$project$Mbta$Api$include($author$project$Mbta$Api$predictionTrip),
				$author$project$Mbta$Api$include($author$project$Mbta$Api$predictionVehicle),
				$author$project$Mbta$Api$include($author$project$Mbta$Api$predictionRoute),
				$author$project$Mbta$Api$include($author$project$Mbta$Api$predictionSchedule)
			]),
		_List_fromArray(
			[
...
var $author$project$Main$init = F3(
	function (flags, url, key) {
		var selections = $author$project$UrlParsing$parseSelectionsFromUrl(url);
		var _v0 = $author$project$Main$streamPredictions(selections);
		...
		return _Utils_Tuple2(
			{
				...
				navigationKey: key,
				newSelectionState: $elm$core$List$isEmpty(selections) ? $author$project$Model$ChoosingRoute : $author$project$Model$NotMakingNewSelection,
				routes: _List_Nil,
				routesByStopId: $pzp1997$assoc_list$AssocList$empty,
...
var $author$project$Model$ChoosingExtraRoutes = F2(
	function (a, b) {
		return {$: 'ChoosingExtraRoutes', a: a, b: b};
	});
var $author$project$Model$ChoosingStop = F3(
	function (a, b, c) {
		return {$: 'ChoosingStop', a: a, b: b, c: c};
	});
...
var $author$project$Mbta$Api$getPrimaryData = function (_v0) {
	var data = _v0.a;
	return data.primaryData;
};
var $author$project$Model$ReceiveStopsForRoutes = F3(
	function (a, b, c) {
		return {$: 'ReceiveStopsForRoutes', a: a, b: b, c: c};
	});
...
var $author$project$Mbta$Api$filterByDirectionId = function (directionId) {
...
var $author$project$Mbta$Api$filterStopsByDirectionId = function (directionId) {
	return $author$project$Mbta$Api$filterByDirectionId(directionId);
};
var $author$project$Mbta$Api$filterStopsByRouteIds = function (routeIds) {
	return A3($author$project$Mbta$Api$filterByList, 'route', $author$project$Mbta$Api$routeIdToString, routeIds);
};
...
var $author$project$Main$getStopsForRoute = F2(
	function (routeId, directionId) {
		return A4(
			$author$project$Mbta$Api$getStops,
			A2($author$project$Model$ReceiveStopsForRoutes, routeId, directionId),
			$author$project$Main$apiHost,
			_List_Nil,
			A2(
				$elm_community$maybe_extra$Maybe$Extra$cons,
				A2($elm$core$Maybe$map, $author$project$Mbta$Api$filterStopsByDirectionId, directionId),
				_List_fromArray(
					[
						$author$project$Mbta$Api$filterStopsByRouteIds(
						_List_fromArray(
							[routeId]))
					])));
	});
var $author$project$Main$getStopsForRoutes = F2(
	function (routeIds, directionId) {
		return $elm$core$Platform$Cmd$batch(
			A2(
				$elm$core$List$map,
				function (routeId) {
					return A2($author$project$Main$getStopsForRoute, routeId, directionId);
				},
				routeIds));
	});
...
var $author$project$UrlParsing$setSelectionsInUrl = F2(
	function (selections, url) {
		var queryParams = A2(
			$elm$core$String$join,
			'&',
			A2($elm$core$List$map, $author$project$UrlParsing$encodeSelectionAsQueryParam, selections));
		return _Utils_update(
			url,
			{
				query: $elm$core$Maybe$Just(queryParams)
			});
	});
...
var $author$project$Main$registerNewSelections = F2(
	function (model, newSelections) {
		return _Utils_Tuple2(
			model,
			A2(
...
var $author$project$Mbta$Api$StreamResultInternal_Loaded = function (a) {
	return {$: 'StreamResultInternal_Loaded', a: a};
};
var $author$project$Mbta$Api$Stream_UnexpectedEvent = function (a) {
	return {$: 'Stream_UnexpectedEvent', a: a};
};
var $author$project$Mbta$Api$Stream_UnexpectedEventOrder = function (a) {
	return {$: 'Stream_UnexpectedEventOrder', a: a};
};
var $author$project$Mbta$Api$Stream_DecodeError = function (a) {
	return {$: 'Stream_DecodeError', a: a};
};
var $author$project$JsonApi$decodeResourceValue = F2(
	function (resourceDecoder, jsonValue) {
		return A4($author$project$JsonApi$decodeValue, $author$project$JsonApi$Untyped$resourceDecoder, $author$project$JsonApi$decodeResource, resourceDecoder, jsonValue);
	});
var $author$project$Mbta$Api$streamInsert = F2(
	function (resourceJson, mixed) {
		return A2(
			$elm$core$Result$map,
			function (mixedInserter) {
				return mixedInserter(mixed);
			},
			A2(
				$elm$core$Result$mapError,
				A2(
...
var $author$project$JsonApi$decodeIdValue = F2(
	function (idDecoder_, jsonValue) {
		return A4($author$project$JsonApi$decodeValue, $author$project$JsonApi$Untyped$resourceIdDecoder, $author$project$JsonApi$decodeId, idDecoder_, jsonValue);
	});
var $author$project$JsonApi$idDecoderByType = function (idDecoders) {
	return $author$project$JsonApi$IdDecoder(
		function (untypedId) {
			var _v0 = A2($elm$core$Dict$get, untypedId.resourceType, idDecoders);
			if (_v0.$ === 'Just') {
				var idDecoder_ = _v0.a;
				return A2($author$project$JsonApi$decodeId, idDecoder_, untypedId);
			} else {
				return $elm$core$Result$Err(
					{
						actualIdValue: untypedId.id,
						actualType: untypedId.resourceType,
						expectedType: $elm$core$Dict$keys(idDecoders)
					});
			}
		});
};
var $author$project$JsonApi$mapId = F2(
	function (f, idDecoder_) {
		return $author$project$JsonApi$IdDecoder(
			function (untypedId) {
				return A2(
					$elm$core$Result$map,
					f,
					A2($author$project$JsonApi$decodeId, idDecoder_, untypedId));
			});
	});
var $author$project$Mbta$Mixed$remove = $author$project$JsonApi$idDecoderByType(
	$elm$core$Dict$fromList(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'prediction',
				A2(
					$author$project$JsonApi$mapId,
					function (predictionId) {
						return function (included) {
							return _Utils_update(
								included,
								{
									predictions: A2($pzp1997$assoc_list$AssocList$remove, predictionId, included.predictions)
								});
						};
					},
					$author$project$Mbta$Decode$predictionId)),
					...
					function (vehicleId) {
						return function (included) {
							return _Utils_update(
								included,
								{
									vehicles: A2($pzp1997$assoc_list$AssocList$remove, vehicleId, included.vehicles)
								});
						};
					},
					$author$project$Mbta$Decode$vehicleId)),
					...
					function (routeId) {
						return function (included) {
							return _Utils_update(
								included,
								{
									routes: A2($pzp1997$assoc_list$AssocList$remove, routeId, included.routes)
								});
						};
					},
					$author$project$Mbta$Decode$routeId)),
				...
				A2(
					$author$project$JsonApi$mapId,
					function (routePatternId) {
						return function (included) {
							return _Utils_update(
								included,
								{
									routePatterns: A2($pzp1997$assoc_list$AssocList$remove, routePatternId, included.routePatterns)
								});
						};
					},
					$author$project$Mbta$Decode$routePatternId)),
					...
					function (lineId) {
						return function (included) {
							return _Utils_update(
								included,
								{
									lines: A2($pzp1997$assoc_list$AssocList$remove, lineId, included.lines)
								});
						};
					},
					$author$project$Mbta$Decode$lineId)),
					...
					function (scheduleId) {
						return function (included) {
							return _Utils_update(
								included,
								{
									schedules: A2($pzp1997$assoc_list$AssocList$remove, scheduleId, included.schedules)
								});
						};
					},
					$author$project$Mbta$Decode$scheduleId)),
					...
					function (tripId) {
						return function (included) {
							return _Utils_update(
								included,
								{
									trips: A2($pzp1997$assoc_list$AssocList$remove, tripId, included.trips)
								});
						};
					},
					$author$project$Mbta$Decode$tripId)),
					...
					function (serviceId) {
						return function (included) {
							return _Utils_update(
								included,
								{
									services: A2($pzp1997$assoc_list$AssocList$remove, serviceId, included.services)
								});
						};
					},
					$author$project$Mbta$Decode$serviceId)),
					...
					function (shapeId) {
						return function (included) {
							return _Utils_update(
								included,
								{
									shapes: A2($pzp1997$assoc_list$AssocList$remove, shapeId, included.shapes)
								});
						};
					},
					$author$project$Mbta$Decode$shapeId)),
					...
					function (stopId) {
						return function (included) {
							return _Utils_update(
								included,
								{
									stops: A2($pzp1997$assoc_list$AssocList$remove, stopId, included.stops)
								});
						};
					},
					$author$project$Mbta$Decode$stopId)),
					...
					function (facilityId) {
						return function (included) {
							return _Utils_update(
								included,
								{
									facilities: A2($pzp1997$assoc_list$AssocList$remove, facilityId, included.facilities)
								});
						};
					},
					$author$project$Mbta$Decode$facilityId)),
					...
					function (facilityId) {
						return function (included) {
							return _Utils_update(
								included,
								{
									liveFacilities: A2($pzp1997$assoc_list$AssocList$remove, facilityId, included.liveFacilities)
								});
						};
					},
					$author$project$Mbta$Decode$facilityId)),
					...
					function (alertId) {
						return function (included) {
							return _Utils_update(
								included,
								{
									alerts: A2($pzp1997$assoc_list$AssocList$remove, alertId, included.alerts)
								});
						};
					},
					$author$project$Mbta$Decode$alertId))
			])));
var $author$project$Mbta$Api$streamRemove = F2(
	function (idJson, mixed) {
		return A2(
			$elm$core$Result$map,
			function (mixedRemover) {
				return mixedRemover(mixed);
			},
			A2(
				$elm$core$Result$mapError,
				A2(
...
var $author$project$Mbta$Api$streamReset = function (dataJson) {
	return A2(
		$elm$core$Result$andThen,
		function (resourceJsons) {
			return A3(
				$elm$core$List$foldl,
				F2(
					function (resourceJson, mixedResult) {
						return A2(
							$elm$core$Result$andThen,
							function (mixed) {
								return A2($author$project$Mbta$Api$streamInsert, resourceJson, mixed);
							},
							mixedResult);
					}),
				$elm$core$Result$Ok($author$project$Mbta$Mixed$empty),
				resourceJsons);
		},
		A2(
			$elm$core$Result$mapError,
...
var $author$project$Mbta$Api$updateStreamMixedResult = F3(
	function (eventString, dataJson, mixedResult) {
		var _v0 = _Utils_Tuple2(mixedResult, eventString);
		if (_v0.a.$ === 'StreamResultInternal_Loading') {
			if (_v0.b === 'reset') {
				var _v1 = _v0.a;
				return $author$project$Mbta$Api$StreamResultInternal_Loaded(
					$author$project$Mbta$Api$streamReset(dataJson));
			} else {
				var _v2 = _v0.a;
				return $author$project$Mbta$Api$StreamResultInternal_Loaded(
					$elm$core$Result$Err(
						$author$project$Mbta$Api$Stream_UnexpectedEventOrder('first event received was \"' + (eventString + '\" instead of \"reset\"'))));
			}
		} else {
			if (_v0.a.a.$ === 'Err') {
				var e = _v0.a.a.a;
				...
				switch (_v0.b) {
					...
					case 'add':
						var mixed = _v0.a.a.a;
						return $author$project$Mbta$Api$StreamResultInternal_Loaded(
							A2($author$project$Mbta$Api$streamInsert, dataJson, mixed));
					case 'update':
						var mixed = _v0.a.a.a;
						return $author$project$Mbta$Api$StreamResultInternal_Loaded(
							A2($author$project$Mbta$Api$streamInsert, dataJson, mixed));
					case 'remove':
						var mixed = _v0.a.a.a;
						return $author$project$Mbta$Api$StreamResultInternal_Loaded(
							A2($author$project$Mbta$Api$streamRemove, dataJson, mixed));
					default:
						return $author$project$Mbta$Api$StreamResultInternal_Loaded(
							$elm$core$Result$Err(
								$author$project$Mbta$Api$Stream_UnexpectedEvent(eventString)));
				}
			}
		}
	});
var $author$project$Mbta$Api$updateStream = F3(
	function (eventString, dataJson, _v0) {
		var streamState = _v0.a;
		return $author$project$Mbta$Api$StreamState(
			_Utils_update(
				streamState,
				{
					mixedResult: A3($author$project$Mbta$Api$updateStreamMixedResult, eventString, dataJson, streamState.mixedResult)
				}));
	});
		...
		switch (msg.$) {
			...
			case 'OnUrlChange':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{selections: newSelections, url: url}),
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
			...
			case 'DeleteSelection':
				var index = msg.a;
				var newSelections = A2($elm_community$list_extra$List$Extra$removeAt, index, model.selections);
			...
			case 'RemoveRouteFromSelection':
				...
				var newSelections = A3(
					...
					model.selections);
				return A2($author$project$Main$registerNewSelections, model, newSelections);
			case 'NewSelectionStart':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{newSelectionState: $author$project$Model$ChoosingRoute}),
					$elm$core$Platform$Cmd$none);
			case 'NewSelectionChoseRoute':
				var routeId = msg.a;
				var _v6 = function () {
					var _v7 = model.newSelectionState;
					if (_v7.$ === 'ChoosingExtraRoutes') {
						var routeIds = _v7.a;
						var existingDirectionId = _v7.b;
						return _Utils_Tuple2(routeIds, existingDirectionId);
					} else {
						return _Utils_Tuple2(_List_Nil, $elm$core$Maybe$Nothing);
					}
				}();
				var existingRouteIds = _v6.a;
				var directionId = _v6.b;
				var newRouteIds = _Utils_ap(
					existingRouteIds,
					_List_fromArray(
						[routeId]));
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							newSelectionState: A3($author$project$Model$ChoosingStop, newRouteIds, directionId, $pzp1997$assoc_list$AssocList$empty)
						}),
					A2($author$project$Main$getStopsForRoutes, newRouteIds, directionId));
			case 'NewSelectionChoseDirection':
				var directionId = msg.a;
				var _v8 = model.newSelectionState;
				if (_v8.$ === 'ChoosingStop') {
					var routeIds = _v8.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								newSelectionState: A3($author$project$Model$ChoosingStop, routeIds, directionId, $pzp1997$assoc_list$AssocList$empty)
							}),
						A2($author$project$Main$getStopsForRoutes, routeIds, directionId));
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{newSelectionState: $author$project$Model$NotMakingNewSelection}),
						$elm$core$Platform$Cmd$none);
				}
			case 'NewSelectionChoseStop':
				var stopId = msg.a;
				var _v9 = model.newSelectionState;
				if (_v9.$ === 'ChoosingStop') {
					var routeIds = _v9.a;
					var directionId = _v9.b;
					var newSelection = {directionId: directionId, routeIds: routeIds, stopId: stopId};
					var newSelections = A2(
						$elm$core$List$append,
						model.selections,
						_List_fromArray(
							[newSelection]));
					var modelWithClosedNewSelection = _Utils_update(
						model,
						{newSelectionState: $author$project$Model$NotMakingNewSelection});
					return A2($author$project$Main$registerNewSelections, modelWithClosedNewSelection, newSelections);
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
			...
			case 'NewSelectionAddExtraRoute':
				var _v10 = model.newSelectionState;
				if (_v10.$ === 'ChoosingStop') {
					var routeIds = _v10.a;
					var directionId = _v10.b;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								newSelectionState: A2($author$project$Model$ChoosingExtraRoutes, routeIds, directionId)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
			case 'NewSelectionRemoveRoute':
				var routeId = msg.a;
				var _v11 = model.newSelectionState;
				switch (_v11.$) {
					case 'ChoosingStop':
						var routeIds = _v11.a;
						var directionId = _v11.b;
						var stopsByRouteId = _v11.c;
						var newRouteIds = A2($elm_community$list_extra$List$Extra$remove, routeId, routeIds);
						return $elm$core$List$isEmpty(newRouteIds) ? _Utils_Tuple2(
							_Utils_update(
								model,
								{newSelectionState: $author$project$Model$ChoosingRoute}),
							...
							_Utils_update(
								model,
								{
									newSelectionState: A3(
										$author$project$Model$ChoosingStop,
										newRouteIds,
										directionId,
										A2($pzp1997$assoc_list$AssocList$remove, routeId, stopsByRouteId))
								}),
							$elm$core$Platform$Cmd$none);
					case 'ChoosingExtraRoutes':
						var routeIds = _v11.a;
						var directionId = _v11.b;
						var newRouteIds = A2($elm_community$list_extra$List$Extra$remove, routeId, routeIds);
						return $elm$core$List$isEmpty(newRouteIds) ? _Utils_Tuple2(
							...
							_Utils_update(
								model,
								{
									newSelectionState: A2($author$project$Model$ChoosingExtraRoutes, newRouteIds, directionId)
								}),
							$elm$core$Platform$Cmd$none);
					default:
						return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
			case 'NewSelectionBack':
				var _v12 = model.newSelectionState;
				switch (_v12.$) {
					case 'ChoosingStop':
						var routeIds = _v12.a;
						var directionId = _v12.b;
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{newSelectionState: $author$project$Model$ChoosingRoute}),
			...
			case 'ReceiveRoutesForStopId':
				...
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			case 'ReceiveStopsForRoutes':
				var requestRouteId = msg.a;
				var requestDirectionId = msg.b;
				var apiResult = msg.c;
				var _v13 = model.newSelectionState;
				if (_v13.$ === 'ChoosingStop') {
					var currentRouteIds = _v13.a;
					var currentDirectionId = _v13.b;
					var previousStopsByRouteId = _v13.c;
					if (_Utils_eq(requestDirectionId, currentDirectionId) && A2($elm$core$List$member, requestRouteId, currentRouteIds)) {
						var newStops = A2(
							$elm$core$Result$withDefault,
							_List_Nil,
							A2($elm$core$Result$map, $author$project$Mbta$Api$getPrimaryData, apiResult));
						var newStopsByRouteId = A3($pzp1997$assoc_list$AssocList$insert, requestRouteId, newStops, previousStopsByRouteId);
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									newSelectionState: A3($author$project$Model$ChoosingStop, currentRouteIds, requestDirectionId, newStopsByRouteId)
								}),
							$elm$core$Platform$Cmd$none);
					} else {
						return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			...
			case 'StreamMsg':
				...
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			default:
				var _v14 = $author$project$Main$streamPredictions(model.selections);
				var initStreamState = _v14.a;
				var streamUrl = _v14.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{lastUpdated: $elm$core$Maybe$Nothing, streamState: initStreamState}),
...
var $author$project$ViewHelpers$avh4ColorToElmUiColor = function (avh4Color) {
	var _v0 = $avh4$elm_color$Color$toRgba(avh4Color);
	var red = _v0.red;
	var green = _v0.green;
	var blue = _v0.blue;
	var alpha = _v0.alpha;
...
var $author$project$Model$NewSelectionStart = {$: 'NewSelectionStart'};
...
var $author$project$ViewHelpers$unit = 16;
...
var $author$project$View$buttonStyles = _List_fromArray(
	[
		$mdgriffith$elm_ui$Element$padding(($author$project$ViewHelpers$unit / 2) | 0),
...
var $author$project$View$newSelection = A2(
	$mdgriffith$elm_ui$Element$Input$button,
	$author$project$View$buttonStyles,
	{
		label: $mdgriffith$elm_ui$Element$text('New'),
		onPress: $elm$core$Maybe$Just($author$project$Model$NewSelectionStart)
	});
...
var $author$project$View$refreshButton = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$spacing($author$project$ViewHelpers$unit),
...
var $author$project$Mbta$Api$Loading = {$: 'Loading'};
var $author$project$Mbta$Api$streamResult = function (_v0) {
	var streamState = _v0.a;
	var _v1 = streamState.mixedResult;
	if (_v1.$ === 'StreamResultInternal_Loading') {
		return $author$project$Mbta$Api$Loading;
	} else {
		if (_v1.a.$ === 'Err') {
			var e = _v1.a.a;
			return $author$project$Mbta$Api$Loaded(
				$elm$core$Result$Err(e));
		} else {
			var mixed = _v1.a.a;
			return $author$project$Mbta$Api$Loaded(
				$elm$core$Result$Ok(
					$author$project$Mbta$Api$Data(
						{
							included: mixed,
...
var $author$project$ViewHelpers$iconButton = F2(
	function (msg, _v0) {
		var src = _v0.src;
		var description = _v0.description;
		return A2(
...
var $author$project$View$directionIcon = F2(
	function (index, directionId) {
		var icon = function () {
			if (directionId.$ === 'Nothing') {
				return {description: 'both directions', src: '/assets/direction-both.svg'};
			} else {
				if (directionId.a.$ === 'D0') {
					var _v1 = directionId.a;
					return {description: 'direction 0', src: '/assets/direction-0.svg'};
				} else {
					var _v2 = directionId.a;
					return {description: 'direction 1', src: '/assets/direction-1.svg'};
				}
			}
		}();
		return A2(
			$author$project$ViewHelpers$iconButton,
			$author$project$Model$ToggleDirection(index),
			icon);
	});
...
var $author$project$Model$DeleteSelection = function (a) {
	return {$: 'DeleteSelection', a: a};
};
var $author$project$View$removeSelection = function (index) {
	return A2(
		$author$project$ViewHelpers$iconButton,
		$author$project$Model$DeleteSelection(index),
		{description: 'remove', src: '/assets/close.svg'});
};
var $author$project$Model$RemoveRouteFromSelection = F2(
	function (a, b) {
		return {$: 'RemoveRouteFromSelection', a: a, b: b};
	});
var $author$project$Pill$listSpacing = $mdgriffith$elm_ui$Element$spacing(($author$project$ViewHelpers$unit / 2) | 0);
var $author$project$Mbta$Extra$routeAbbreviation = function (route) {
	var _v0 = route.shortName;
	if (_v0.$ === 'Just') {
		var shortName = _v0.a;
		return $elm$core$Maybe$Just(shortName);
	} else {
		var _v1 = route.id;
		switch (_v1.a) {
			case 'Red':
				return $elm$core$Maybe$Just('RL');
			case 'Mattapan':
				return $elm$core$Maybe$Just('M');
			case 'Orange':
				return $elm$core$Maybe$Just('OL');
			case 'Blue':
				return $elm$core$Maybe$Just('BL');
			case 'Green-B':
			...
			case '746':
				return $elm$core$Maybe$Just('SLW');
			case 'CR-Fairmount':
				return $elm$core$Maybe$Just('FMT');
			case 'CR-Fitchburg':
				return $elm$core$Maybe$Just('FIT');
			case 'CR-Worcester':
				return $elm$core$Maybe$Just('WOR');
			case 'CR-Franklin':
				return $elm$core$Maybe$Just('FRK');
			case 'CR-Greenbush':
				return $elm$core$Maybe$Just('GRN');
			case 'CR-Haverhill':
				return $elm$core$Maybe$Just('HVL');
			case 'CR-Kingston':
				return $elm$core$Maybe$Just('KIN');
			case 'CR-Lowell':
				return $elm$core$Maybe$Just('LWL');
			case 'CR-Middleborough':
				return $elm$core$Maybe$Just('MID');
			case 'CR-Needham':
				return $elm$core$Maybe$Just('NDM');
			case 'CR-Newburyport':
				return $elm$core$Maybe$Just('NEW');
			case 'CR-Providence':
				return $elm$core$Maybe$Just('PRO');
			case 'CR-Foxboro':
				return $elm$core$Maybe$Just('FXB');
			case 'Boat-F1':
				return $elm$core$Maybe$Just('HNG');
			case 'Boat-F4':
				return $elm$core$Maybe$Just('CHA');
			default:
				return $elm$core$Maybe$Nothing;
		}
	}
};
var $author$project$Pill$pill = function (route) {
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$ViewHelpers$avh4ColorToElmUiColor(route.color)),
				$mdgriffith$elm_ui$Element$Font$color(
				$author$project$ViewHelpers$avh4ColorToElmUiColor(route.textColor))
			]),
		$mdgriffith$elm_ui$Element$text(
			A2(
				$elm$core$Maybe$withDefault,
				route.longName,
				$author$project$Mbta$Extra$routeAbbreviation(route))));
};
var $avh4$elm_color$Color$black = A4($avh4$elm_color$Color$RgbaSpace, 0 / 255, 0 / 255, 0 / 255, 1.0);
var $avh4$elm_color$Color$white = A4($avh4$elm_color$Color$RgbaSpace, 255 / 255, 255 / 255, 255 / 255, 1.0);
var $author$project$Pill$unknownPill = function (_v0) {
	var routeIdText = _v0.a;
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$Border$rounded(16),
				$mdgriffith$elm_ui$Element$Background$color(
				$author$project$ViewHelpers$avh4ColorToElmUiColor($avh4$elm_color$Color$black)),
				$mdgriffith$elm_ui$Element$Font$color(
				$author$project$ViewHelpers$avh4ColorToElmUiColor($avh4$elm_color$Color$white))
			]),
...
var $author$project$View$selectedRoutePills = F3(
	function (index, selectedRoutes, unknownSelectedRouteIds) {
		return A2(
			$mdgriffith$elm_ui$Element$wrappedRow,
			_List_fromArray(
				[
					$author$project$Pill$listSpacing,
					$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill)
				]),
			$elm$core$List$concat(
				_List_fromArray(
					[
						...
						function (route) {
							return A2(
								...
								_List_Nil,
								{
									label: $author$project$Pill$pill(route),
									onPress: $elm$core$Maybe$Just(
										A2($author$project$Model$RemoveRouteFromSelection, index, route.id))
								});
						},
						selectedRoutes),
						A2(
						...
						function (routeId) {
							return A2(
								...
								_List_Nil,
								{
									label: $author$project$Pill$unknownPill(routeId),
									onPress: $elm$core$Maybe$Just(
										A2($author$project$Model$RemoveRouteFromSelection, index, routeId))
								});
						},
...
var $author$project$View$selectionStopName = F2(
	function (stop, selection) {
		...
		return A2(
			...
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$text(stopName)
				]));
	});
var $author$project$Model$AddRouteToSelection = F2(
	function (a, b) {
		return {$: 'AddRouteToSelection', a: a, b: b};
	});
...
var $author$project$View$unselectedRoutePills = F2(
	function (index, unselectedRoutes) {
		return A2(
			$mdgriffith$elm_ui$Element$wrappedRow,
			_List_fromArray(
				[
				...
				function (route) {
					return A2(
							...
							]),
						{
							label: $author$project$Pill$pill(route),
							onPress: $elm$core$Maybe$Just(
								A2($author$project$Model$AddRouteToSelection, index, route.id))
						});
				},
				unselectedRoutes));
	});
var $author$project$View$emptyPrediction = A2(
	$mdgriffith$elm_ui$Element$el,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$padding($author$project$ViewHelpers$unit)
		]),
	$mdgriffith$elm_ui$Element$text('No predicted trips'));
...
var $author$project$Mbta$Api$getIncludedRoute = F2(
	function (routeId, _v0) {
		var data = _v0.a;
		return A2($pzp1997$assoc_list$AssocList$get, routeId, data.included.routes);
	});
var $author$project$Mbta$Api$getIncludedSchedule = F2(
	function (scheduleId, _v0) {
		var data = _v0.a;
		return A2($pzp1997$assoc_list$AssocList$get, scheduleId, data.included.schedules);
	});
var $author$project$Mbta$Api$getIncludedStopStop = F2(
	function (stopId, _v0) {
		var data = _v0.a;
		var _v1 = A2($pzp1997$assoc_list$AssocList$get, stopId, data.included.stops);
		if ((_v1.$ === 'Just') && (_v1.a.$ === 'Stop_0_Stop')) {
			var stop_stop = _v1.a.a;
			return $elm$core$Maybe$Just(stop_stop);
		} else {
			return $elm$core$Maybe$Nothing;
		}
	});
...
var $author$project$Mbta$Api$getIncludedVehicle = F2(
	function (vehicleId, _v0) {
		var data = _v0.a;
...
var $author$project$ViewModel$predictionMatchesDirection = F2(
	function (selectionDirection, prediction) {
		if (selectionDirection.$ === 'Nothing') {
			return true;
		} else {
			var directionId = selectionDirection.a;
			return _Utils_eq(prediction.directionId, directionId);
		}
	});
var $author$project$ViewModel$predictionMatchesRouteId = F2(
	function (routeIds, prediction) {
			...
			function (prediction) {
				...
				var shouldShowSchedule = function () {
					if (route.$ === 'Nothing') {
						...
						var routeType = route.a.routeType;
						return A2(
...
var $author$project$View$timeZone = $justinmimbs$timezone_data$TimeZone$america__new_york(_Utils_Tuple0);
...
var $author$project$View$absoluteTimeString = function (time) {
	return $elm$core$String$concat(
		_List_fromArray(
			[
				A3(
				...
				_Utils_chr('0'),
				$elm$core$String$fromInt(
					A2($elm$time$Time$toHour, $author$project$View$timeZone, time))),
				':',
				A3(
				$elm$core$String$padLeft,
				2,
...
var $author$project$View$viewPrediction = F3(
	function (currentTime, index, prediction) {
		return A2(
			$mdgriffith$elm_ui$Element$row,
			_List_fromArray(
				[
					...
					$author$project$ViewHelpers$avh4ColorToElmUiColor($avh4$elm_color$Color$charcoal)),
					$mdgriffith$elm_ui$Element$Background$color(
					$author$project$ViewHelpers$avh4ColorToElmUiColor(prediction.backgroundColor)),
					$mdgriffith$elm_ui$Element$Font$color(
					$author$project$ViewHelpers$avh4ColorToElmUiColor(prediction.textColor)),
				...
				[
					...
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$px($author$project$ViewHelpers$unit * 8)),
							$mdgriffith$elm_ui$Element$padding(($author$project$ViewHelpers$unit / 2) | 0),
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$width(
							$mdgriffith$elm_ui$Element$px($author$project$ViewHelpers$unit * 2))
						]),
					function () {
						var _v0 = prediction.platformCode;
						if (_v0.$ === 'Nothing') {
							return $mdgriffith$elm_ui$Element$none;
						} else {
							var platformCode = _v0.a;
							return A2(
								$mdgriffith$elm_ui$Element$el,
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$padding(($author$project$ViewHelpers$unit / 4) | 0),
										$mdgriffith$elm_ui$Element$centerX,
										$mdgriffith$elm_ui$Element$Border$width(1),
										$mdgriffith$elm_ui$Element$Border$rounded(4)
									]),
								$mdgriffith$elm_ui$Element$text(platformCode));
						}
					}()),
					A2(
					...
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
							$mdgriffith$elm_ui$Element$padding(($author$project$ViewHelpers$unit / 2) | 0),
							$mdgriffith$elm_ui$Element$spacing(($author$project$ViewHelpers$unit / 4) | 0)
						]),
					_List_fromArray(
						[
							function () {
							var _v1 = prediction.tripHeadsign;
							if (_v1.$ === 'Nothing') {
								return A2(
									$mdgriffith$elm_ui$Element$el,
									_List_fromArray(
									...
									$mdgriffith$elm_ui$Element$text(prediction.routeName));
							} else {
								var headsign = _v1.a;
								return A2(
									$mdgriffith$elm_ui$Element$row,
									...
									_List_fromArray(
										[
											...
											$mdgriffith$elm_ui$Element$text(prediction.routeName)),
											$mdgriffith$elm_ui$Element$text(' - '),
											$mdgriffith$elm_ui$Element$text(headsign)
										]));
							}
						}(),
							function () {
...
var $author$project$View$viewPredictions = F3(
	function (currentTime, data, selection) {
		var predictions = A2(
			$elm$core$List$take,
			5,
			A2(
				...
				A2($author$project$ViewModel$predictionsForSelection, data, selection)));
		return A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
			...
			$elm$core$List$isEmpty(predictions) ? _List_fromArray(
				[$author$project$View$emptyPrediction]) : A2(
...
var $author$project$View$viewSelection = F6(
	function (index, currentTime, routes, stop, data, selection) {
		var _v0 = A2(
			...
			function (route) {
				return A2($elm$core$List$member, route.id, selection.routeIds);
			},
			routes);
		var selectedRoutes = _v0.a;
		var unselectedRoutes = _v0.b;
		var unknownSelectedRouteIds = A2(
			$elm$core$List$filter,
			function (routeId) {
				return !A2(
					$elm$core$List$member,
			...
			selection.routeIds);
		var hasSelectedRoutes = (!$elm$core$List$isEmpty(selectedRoutes)) || (!$elm$core$List$isEmpty(unknownSelectedRouteIds));
		return A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							A2($author$project$View$selectionStopName, stop, selection),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[$mdgriffith$elm_ui$Element$alignRight]),
							A2($author$project$View$directionIcon, index, selection.directionId)),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[$mdgriffith$elm_ui$Element$alignRight]),
					...
					hasSelectedRoutes ? A3($author$project$View$selectedRoutePills, index, selectedRoutes, unknownSelectedRouteIds) : $mdgriffith$elm_ui$Element$none,
					$elm$core$List$isEmpty(unselectedRoutes) ? $mdgriffith$elm_ui$Element$none : A2($author$project$View$unselectedRoutePills, index, unselectedRoutes),
					hasSelectedRoutes ? A3($author$project$View$viewPredictions, currentTime, data, selection) : A2(
					$mdgriffith$elm_ui$Element$el,
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$padding($author$project$ViewHelpers$unit)
...
var $author$project$View$viewSelections = F5(
	function (currentTime, routesByStopId, stops, data, selections) {
		return A2(
			...
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$spacing(2 * $author$project$ViewHelpers$unit),
					$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill)
				]),
			A2(
				$elm$core$List$indexedMap,
				F2(
					function (index, selection) {
						...
						var routes = A2(
							$elm$core$Maybe$withDefault,
							_List_Nil,
							A2($pzp1997$assoc_list$AssocList$get, selection.stopId, routesByStopId));
...
var $author$project$View$ui = function (model) {
	return A2(
		...
		function () {
			var _v0 = $author$project$Mbta$Api$streamResult(model.streamState);
			if (_v0.$ === 'Loading') {
				return _List_fromArray(
					[
						$mdgriffith$elm_ui$Element$text('Loading...'),
						$author$project$View$newSelection,
...
var $author$project$Model$NewSelectionBack = {$: 'NewSelectionBack'};
var $author$project$Model$NewSelectionCancel = {$: 'NewSelectionCancel'};
var $author$project$NewSelection$header = F2(
	function (showBack, text) {
		return A2(
			$mdgriffith$elm_ui$Element$row,
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
					$mdgriffith$elm_ui$Element$padding(($author$project$ViewHelpers$unit / 2) | 0),
					$mdgriffith$elm_ui$Element$spacing(($author$project$ViewHelpers$unit / 2) | 0)
				]),
			_List_fromArray(
				[
					A2(
					...
					A2(
						$author$project$ViewHelpers$iconButton,
						$author$project$Model$NewSelectionBack,
						{description: 'back', src: '/assets/back.svg'})) : $mdgriffith$elm_ui$Element$none,
					A2(
					$mdgriffith$elm_ui$Element$el,
					_List_fromArray(
						[$mdgriffith$elm_ui$Element$alignRight]),
					A2(
						$author$project$ViewHelpers$iconButton,
						$author$project$Model$NewSelectionCancel,
						{description: 'close', src: '/assets/close.svg'}))
				]));
	});
var $author$project$Model$NewSelectionRemoveRoute = function (a) {
	return {$: 'NewSelectionRemoveRoute', a: a};
};
var $author$project$Model$NewSelectionAddExtraRoute = {$: 'NewSelectionAddExtraRoute'};
var $author$project$NewSelection$addPill = A2(
	$mdgriffith$elm_ui$Element$Input$button,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$padding(4),
		...
		]),
	{
		label: A2(
			...
			{description: 'Add route', src: '/assets/add.svg'}),
		onPress: $elm$core$Maybe$Just($author$project$Model$NewSelectionAddExtraRoute)
	});
var $author$project$NewSelection$pillList = F2(
	function (routes, showAddRouteButton) {
		return A2(
			$mdgriffith$elm_ui$Element$wrappedRow,
			_List_fromArray(
				[$author$project$Pill$listSpacing]),
					...
					function (route) {
						return A2(
							...
							_List_Nil,
							{
								label: $author$project$Pill$pill(route),
								onPress: $elm$core$Maybe$Just(
									$author$project$Model$NewSelectionRemoveRoute(route.id))
							});
					},
					routes),
				showAddRouteButton ? _List_fromArray(
					[$author$project$NewSelection$addPill]) : _List_Nil));
	});
var $author$project$Model$NewSelectionChoseRoute = function (a) {
	return {$: 'NewSelectionChoseRoute', a: a};
};
var $avh4$elm_color$Color$lightCharcoal = A4($avh4$elm_color$Color$RgbaSpace, 136 / 255, 138 / 255, 133 / 255, 1.0);
var $author$project$NewSelection$buttonList = F3(
	function (msg, viewElem, elems) {
		return A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
				...
				function (elem) {
					return A2(
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$Border$color(
								$author$project$ViewHelpers$avh4ColorToElmUiColor($avh4$elm_color$Color$lightCharcoal)),
								$mdgriffith$elm_ui$Element$Border$widthEach(
...
var $author$project$NewSelection$routeListRoute = function (route) {
	return A2(
		$mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$width(
						$mdgriffith$elm_ui$Element$px($author$project$ViewHelpers$unit * 4))
					]),
				$author$project$Pill$pill(route)),
				A2(
				$mdgriffith$elm_ui$Element$paragraph,
				_List_Nil,
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$text(route.longName)
					]))
			]));
};
var $author$project$NewSelection$routeList = function (routes) {
	return A3(
		$author$project$NewSelection$buttonList,
		A2(
			$elm$core$Basics$composeL,
			$author$project$Model$NewSelectionChoseRoute,
			function ($) {
				return $.id;
			}),
		$author$project$NewSelection$routeListRoute,
		routes);
};
var $author$project$NewSelection$selectedRoutes = F2(
	function (allRoutes, selectedRouteIds) {
		return A2(
			$elm$core$List$filter,
			function (route) {
				return A2($elm$core$List$member, route.id, selectedRouteIds);
			},
			allRoutes);
	});
var $author$project$NewSelection$chooseExtraRoute = F2(
	function (allRoutes, selectedRouteIds) {
		return A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
			...
			_List_fromArray(
				[
					A2($author$project$NewSelection$header, true, 'Choose Another Route'),
					A2(
					$author$project$NewSelection$pillList,
					A2($author$project$NewSelection$selectedRoutes, allRoutes, selectedRouteIds),
					false),
					$author$project$NewSelection$routeList(allRoutes)
				]));
	});
var $author$project$NewSelection$chooseRoute = function (allRoutes) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				A2($author$project$NewSelection$header, false, 'Choose Route'),
				$author$project$NewSelection$routeList(allRoutes)
			]));
};
...
var $author$project$ListHelpers$listIntersect = function (lists) {
	if (!lists.b) {
		return _List_Nil;
	} else {
		var first = lists.a;
		...
		return A2(
			...
			function (elem) {
				return A2(
					$elm$core$List$all,
					$elm$core$List$member(elem),
					rest);
			},
			first);
	}
};
var $author$project$Model$NewSelectionChoseStop = function (a) {
	return {$: 'NewSelectionChoseStop', a: a};
};
var $author$project$NewSelection$stopListStop = function (stop) {
	return A2(
		$mdgriffith$elm_ui$Element$paragraph,
		_List_fromArray(
			[
...
var $author$project$NewSelection$stopList = function (stops) {
	return A3(
		$author$project$NewSelection$buttonList,
		A2($elm$core$Basics$composeL, $author$project$Model$NewSelectionChoseStop, $author$project$Mbta$stopId),
		$author$project$NewSelection$stopListStop,
		stops);
};
var $author$project$NewSelection$chooseStop = F2(
	function (routes, stopsByRouteId) {
		var stops = $author$project$ListHelpers$listIntersect(
			$pzp1997$assoc_list$AssocList$values(stopsByRouteId));
		return A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					A2($author$project$NewSelection$header, true, 'Choose Stop'),
					A2($author$project$NewSelection$pillList, routes, true),
					$author$project$NewSelection$stopList(stops)
				]));
	});
...
var $author$project$ListHelpers$dictKeepOnly = F2(
	function (keys, dict) {
		return A2(
			$pzp1997$assoc_list$AssocList$filter,
			F2(
				function (k, _v0) {
					return A2($elm$core$List$member, k, keys);
				}),
			dict);
	});
...
var $author$project$NewSelection$modalBackground = A2(
	$mdgriffith$elm_ui$Element$el,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
			$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
			$mdgriffith$elm_ui$Element$Background$color(
			$author$project$ViewHelpers$avh4ColorToElmUiColor($avh4$elm_color$Color$darkCharcoal)),
			$mdgriffith$elm_ui$Element$alpha(0.5),
			$mdgriffith$elm_ui$Element$Events$onClick($author$project$Model$NewSelectionCancel)
		]),
...
var $author$project$NewSelection$modalWrapper = function (child) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
				$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
				$mdgriffith$elm_ui$Element$padding($author$project$ViewHelpers$unit * 2),
				$mdgriffith$elm_ui$Element$behindContent($author$project$NewSelection$modalBackground),
...
var $author$project$NewSelection$viewModal = F2(
	function (routes, newSelectionState) {
		switch (newSelectionState.$) {
			case 'NotMakingNewSelection':
				return $mdgriffith$elm_ui$Element$none;
			case 'ChoosingRoute':
				return $author$project$NewSelection$modalWrapper(
					$author$project$NewSelection$chooseRoute(routes));
			case 'ChoosingStop':
				var routeIds = newSelectionState.a;
				var directionId = newSelectionState.b;
				var loadedStopsByRouteId = newSelectionState.c;
				return $author$project$NewSelection$modalWrapper(
					A2(
						$author$project$NewSelection$chooseStop,
						A2($author$project$NewSelection$selectedRoutes, routes, routeIds),
						A2($author$project$ListHelpers$dictKeepOnly, routeIds, loadedStopsByRouteId)));
			default:
				var routeIds = newSelectionState.a;
				var directionId = newSelectionState.b;
				return $author$project$NewSelection$modalWrapper(
					A2($author$project$NewSelection$chooseExtraRoute, routes, routeIds));
		}
	});
			...
			[
				...
				_List_fromArray(
					[
						...
						A2($author$project$NewSelection$viewModal, model.routes, model.newSelectionState))
					]),
